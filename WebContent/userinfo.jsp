            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        console.log(data[i]);
                        str.push( "<div class='layui-col-md12'>" +
                    ...
                    laypage.render({
                            ...
                            , jump: function (obj) {
                                //模拟渲染
                                document.getElementById('testlist').innerHTML = function () {
                                    var arr = []
                ...
                $.ajax({
                    ...
                    success: function (data) {
                      ...
                      laypage.render({
                            ...
                            , jump: function (obj) {
                                //模拟渲染
                                document.getElementById('questionlist').innerHTML = function () {
                                    var arr = []
                                        , thisData = str.concat().splice(obj.curr * obj.limit - obj.limit, obj.limit);
                                    layui.each(thisData, function (index, item) {
                                        arr.push(item);
                    ...
                    success: function (data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                         ...
                         laypage.render({
                            ...
                            , jump: function (obj) {
                                //模拟渲染
                                document.getElementById('collectlist').innerHTML = function () {
                                    var arr = []
                                        , thisData = str.concat().splice(obj.curr * obj.limit - obj.limit, obj.limit);
                                    layui.each(thisData, function (index, item) {
                                        arr.push(item);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        laypage.render({
                            ...
                            , jump: function (obj) {
                                //模拟渲染
                                document.getElementById('answerlist').innerHTML = function () {
                                    var arr = []
                                        , thisData = str.concat().splice(obj.curr * obj.limit - obj.limit, obj.limit);
                                    layui.each(thisData, function (index, item) {
                                        arr.push(item);
...
<body>
    ...
    <div class="header">
        <div class="main">
            ...
            <c:if test="${!empty  CurrentUser}">
                <div class="nav-user">
                    <a class="avatar" href="CounterFollowGuanZhuServlet"> <img src="${ CurrentUser.getHead_photo()}">
                        <cite>${ CurrentUser.nick_name}</cite>
                    </a>
                    <div class="nav">
                        <a href="logoutServlet" target="_parent"><i class="iconfont icon-tuichu"
            ...
            <c:if test="${empty  applicationScope.CurrentUser}">
                <div class="nav-user">
                    ...
                    <div class="nav" style="font-size: 14px; color: white; margin-top: -5px; margin-left: 1px;">
                        <a href="login.html" target="_parent">登录</a> <a href="register.html" target="_parent">注册</a>
                    </div>
                </div>
            </c:if>
        </div>
    ...
    <div clsss="layui-row" style="margin-top:65px">
        ...
        <div class="layui-col-md2 layui-col-md-offset2" style="padding: 30px;background-color: #F2F2F2; display: inline-block;
            ...
            <div class="layui-col-md12;margin:0 auto; position: absolute;
                ...
                <div class="layui-card"
                    ...
                    <div class="layui-card-body">
                        ...
                        <span style="font-size: 22">${CurrentUser.getNick_name()}</span>
                        <hr>
                        <i class="layui-icon layui-icon-list" style="height: 20px;"></i>
                        <span>${CurrentUser.getIntroduce()}</span>
                        <hr>
        ...
        <div class="layui-col-md4 layui-col-md-offset1" style="width: 30%;position:relative">
    ...
    <div id="page" class="layui-col-md4 layui-col-md-offset6" style=" position:fixed; bottom:0px; height:50px; z-index:9999"> </div>
